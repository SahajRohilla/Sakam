export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-white pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Footer Content */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 pb-16">
          {/* Brand */}
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <div className="space-y-8">
              <div>
                <a href="#" className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 dark:from-blue-300 dark:to-cyan-300 bg-clip-text text-transparent">
                  Sakam
                </a>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-400 dark:text-gray-500">contact@sakam.dev</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="flex-shrink-0 w-5 h-5 text-gray-400 dark:text-gray-500">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold text-gray-300 dark:text-gray-400 uppercase tracking-wider mb-4">
              Services
            </h3>
